                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse home-header" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Resources</a>
                                  <ul class="dropdown-menu" role="menu">
                                    <li><a href="#" target="_blank">PB1-W | In-Wall PlayBox Spec Sheet</a></li>
                                    <li><a href="#" target="_blank">PB1-C | In-Ceiling PlayBox Spec Sheet</a></li>
                                    <li><a href="#" target="_blank">PlayBox Commercial Overview</a></li>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="#">Installation Instructions</a>
                                        <ul class="dropdown-menu">
                                            <li><a tabindex="-1" href="#" target="_blank">PB1-W | In-Wall PlayBox</a></li>
                                            <li><a href="#" target="_blank">PB1-C | In-Ceiling PlayBox</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="#">Cutting Templates</a>
                                        <ul class="dropdown-menu">
                                            <li><a tabindex="-1" href="#" target="_blank">PB1-W | Wall Template</a></li>
                                            <li><a href="#" target="_blank">PB1-C | Ceiling Template</a></li>
                                        </ul>
                                    </li>
                                  </ul>
                                </li>
                                ...
                                <li class="home-shop-btn"><a href="http://www.thenos.us/index.php?route=product/category&path=59" class="btn btn-default download-btnsmall" id="downloadsmall">shop</a></li>
                                <li class="home-sign-btn"><a href="http://www.thenos.us/index.php?route=account/login" class="btn btn-default download-btnsmall" id="downloadsmallwhite">sign-in</a></li>
                            </ul>
                        </div>  <!--end collapse -->
                    </div>  <!--end container -->
                </nav>
