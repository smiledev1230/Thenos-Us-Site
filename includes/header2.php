...
<html><head>
       ...
       <title>PlayBox by thenos | wall-box for the Sonos Play:1 </title>
                ...
                <nav class="navbar fixed-nav navbar-default  navbar-fixed-top" id="main-navbar" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a href="home.php" class="navbar-brand top-logo"><img src="images/logo.png" alt="logo"></a>
                        </div>  <!--end navbar-header -->

                        <div class="collapse navbar-collapse" id="navbar-collapse">

                            <ul class="nav navbar-nav navbar-right">
                                  <li><a href="http://www.thenos.us/<?php if(!$home) echo 'home.php'; ?>#home">home</a></li>
                                <li><a href="http://www.thenos.us/<?php if(!$home) echo 'home.php'; ?>#whatis">what's PlayBox&trade;?</a></li>
                                
                                <li><a href="http://www.thenos.us/<?php if(!$home) echo 'home.php'; ?>#models">models</a></li>
                                <li><a href="http://www.thenos.us/Thenos%20PlayBox%20Spec%20Sheet%202016.pdf">#models>PDF</a></li>
                                <li><a href="http://www.thenos.us/<?php if(!$home) echo 'home.php'; ?>#screenshot">videos/photos</a></li>
                                <li><a href="dealer.php">resellers</a></li>
                ...
                <nav class="navbar fixed-nav navbar-default  navbar-fixed-top" id="main-navbar" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a href="home.php" class="navbar-brand top-logo"><img src="images/logo.png"></a>
                        </div>  <!--end navbar-header -->

                        <div class="collapse navbar-collapse" id="navbar-collapse">

                            <ul class="nav navbar-nav navbar-right">
                                   <li><a href="<?php if(!$home) echo 'home.php'; ?>#home">home</a></li>
