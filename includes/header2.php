    ...
    <body data-spy="scroll" data-target="#main-navbar">
        ...
        <div id="page" class="page">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#" target="_blank">PB1-W | In-Wall PlayBox One Sheet</a></li>
            <li><a href="#" target="_blank">PB1-C | In-Ceiling PlayBox One Sheet</a></li>
            <li><a href="#" target="_blank">PlayBox Commercial Overview</a></li>
            <li><a href="#" target="_blank">Installation Instructions</a></li>
            <li><a href="#" target="_blank">Cutting Templates</a></li>
            <li><a href="#" target="_blank">PB1-C Resources</a></li>
