...
<html><head>
       ...
       <title>Thenos | Makers of the PlayBox </title>
        ...
        <div id="page" class="page">
                ...
                <nav class="navbar fixed-nav navbar-default  navbar-fixed-top" id="main-navbar" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a href="home.php" class="navbar-brand top-logo"><img src="image/thenoscircle.png" alt="logo"></a>
                        </div>  <!--end navbar-header -->

                        <div class="collapse navbar-collapse" id="navbar-collapse">

                            <ul class="nav navbar-nav navbar-right">
                             <li><a href="/home.php#whatis">what's PlayBox&trade;?</a></li>
                                
                                <li><a href="home.php"#models>models</a></li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="http://www.thenos.us/pdf/Thenos PlayBox PB1 - PDF Wall Template.pdf" target="_blank">Install Template - PB1-W</a></li>
                                ...
                                <li><a href="/home.php#screenshot>videos/photos</a></li>
