...
<script>
var bgImageArray = ["4.jpg","1.jpg", "2.jpg", "3.jpg",  "5.jpg"],
base = "http://thenos.us/image/",
secs = 4;
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="home-intro-half st-2nd-half">
                                    <!--Header text -->
                                    <h1><strong>meet the PlayBox<sup>&trade;</sup> by thenos :)</strong><br>
invented by installers
<br></h1>
                                    <h3><strong>the original and only wall-box for the Sonos<sup>&reg;</sup> Play:1<sup>&trade;</sup></strong> 
take your Play:1<sup>&trade;</sup> from tabletop to in-wall and 
get rid of unsightly cords...</h3>

                                    <!--DOWNLOAD BUTTON -->
                                    <div class="download-button">
                                    	 <a href="#overview" class="btn download-btnhome">features</a>
                                        <a href="http://thenos.us/index.php?route=product/category&path=59" class="btn download-btnhome">pre-order</a>
...
neatly nest and showcase the Sonos<sup>&reg;</sup> Play:1<sup>&trade;</sup></p>
                                    ...
                                    <li class="features-list-item">
                                        <h4>color options</h4>
                                        <p>available in two colors: artic white or stealth black to match the Play:1<sup>&trade;</sup></p>
                                    </li>
                                </ul>
                            </div>
...
Enter the PlayBox<sup>&trade;</sup> by thenos - it’s like having your cake while eating more delicious cake.
                                </p>
                            </div>
                        </div><!--end half-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="service text-center  wow fadeInLeft " data-wow-offset="120" data-wow-duration="1.5s">
                               <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=50" style="color:white"> <img src="images/uploads/PlayBox-Models-PB1-PRO.png" />
                                <h4>PlayBox<sup>&trade;</sup> PRO: PB1-PRO</h4>
...
residential electrical source</p>
                        	...
                        	<div class="text-center ">
                                        <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=50" class="btn download-btn">details/order</a>
                            </div>
                        </div><!--end 4 col-->
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="service text-center  wow fadeIn " data-wow-offset="120" data-wow-duration="1.5s">
                              <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=51" style="color:white"> <img src="images/uploads/PlayBox-Models-PB1-EZ.png" />
                                <h4>PlayBox<sup>&trade;</sup> EZ: PB1-EZ</h4>
                                <p>Same as PRO model but includes a power relocation kit, safely and easily wire your PlayBox<sup>&trade;</sup> using a nearby existing electrical outlet 
 
</p></a>
                            </div>
                        	<div class="text-center ">
                                        <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=51" class="btn download-btn">details/order</a>
                            </div>
                        </div><!--end 4 col-->
                        ...
                        <div class="describe-videos">
                            <div class="col-md-6">
                                ...
                                <div class="heading black-text wow fadeIn  animated animated animated animated animated" data-wow-offset="120" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s;">
                                    ...
                                    <div class="subtitle-half"><h5>be among the first to receive the one-of-a-kind PlayBox<sup>&trade;</sup></h5></div>
                                    <div class="separator-left"></div>
                                </div>
                               ...
                               The <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=50" class="under">PRO</a> & <a href="http://thenos.us/index.php?route=product/product&path=59&product_id=51" class="under">EZ</a> versions of the PlayBox<sup>&trade;</sup> are designated for 
wide release by beginning of 2nd the QTR. Order your PlayBox<sup>&trade;</sup> 
by thenos today<br><br>

                                        <a href="http://thenos.us/index.php?route=product/category&path=59" class="btn btn-default download-btnsmall">pre-order</a>
                                        <a href="commercial.php" class="btn btn-default download-btnsmall">PlayBox<sup>&trade;</sup> for commercial</a>
                                        <a href="dealer.php" class="btn btn-default download-btnsmall">resellers</a>
                            </div>
                        </div> <!--end half-->
