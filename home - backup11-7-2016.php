...
if($v=='1'){
	echo '<style>.testimonial,#features,#describe,#home1,#homeMobile,#download,.mailbgplaybox{display:none;}; </style>';
	}
?>
<script>
            ...
            <ul class="slides">
                <li class="flex-active-slide">
                    ...
                    <h2>the</h2>
                        ...
                        <h2>wall-box for the Sonos® Play:1™</h2>
                        <p>
...
<section id="homeMobile" >
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				<iframe id="playerM" width="100%" height="240" src="https://www.youtube.com/embed/KYqv_5TN-VM?version=3&amp;autoplay=0&amp;controls=1&amp;showinfo=0&amp;modestbranding=1&amp;wmode=transparent&amp;rel=0&amp;loop=1&amp;enablejsapi=1" frameborder="0" allowfullscreen>a</iframe>
			</div>
			<div class="col-sm-6">
				<h1>The PlayBox<sup style="font-size:14px !important;vertical-align:top; top:0px">TM</sup></h1>
				<h2>by thenos<sup>®</sup></h2>
				<ul class="txt-m">
					<li>The original and only</li>
