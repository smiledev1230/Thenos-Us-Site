   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input style="margin: 10px 0;" type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
            <a style="margin: 10px 0;" href="<?php echo $product['remove']; ?>" class="btn btn-danger"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
    </div>
