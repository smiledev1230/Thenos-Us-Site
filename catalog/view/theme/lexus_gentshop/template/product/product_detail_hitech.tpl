        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <?php if ($review_status) { ?>
                    ...
                    <a href="#review-form" class="popup-with-form hidden" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;" ><?php echo $reviews; ?></a> / <a href="#review-form"  class="popup-with-form hidden" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;" ><?php echo $text_write; ?></a>
                <?php } ?>
...
<div class="tabs-group box product-box-bottom">
