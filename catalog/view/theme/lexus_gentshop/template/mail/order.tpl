...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="http://www.thenos.us/image/catalog/demo/logo-footer.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><em><?php echo $comment; ?></em><br>
<br>

*Regardless of express shipping selection, items still require the standard fulfillment time. Typical fulfillment for most in-stock product is 2-3 business days or less.<br>

If you have any questions or need assistance please contact us: <a href="mailto:support@thenos.us">support@thenos.us</a></td>
      </tr>
    </tbody>
  </table>
  <?php } ?>
