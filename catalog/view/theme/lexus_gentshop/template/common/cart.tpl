...
<div id="cart" class="clearfix quick-cart">
    <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="heading dropdown-toggle">
       <div class="cart-inner pull-right">
        <a>
          <i class="cart-icon"></i>
          <h4 class="hidden-xs"><?php echo $objlang->get("my cart"); ?></h4>
          <span id="cart-total" class="hidden-xs"><?php echo $text_items; ?></span>
    ...
    <ul class="dropdown-menu content">
      ...
      <li>
        <div class="table-responsive">
          ...
          <p class="text-right">
            <a href="<?php echo $cart; ?>" class="btn btn-outline-default">
              <?php echo $text_cart; ?>
            </a>&nbsp;&nbsp;&nbsp;
            <a href="<?php echo $checkout; ?>" class="btn btn-outline-default">
