...
?>
 <div class="megaproducts" id="megaproducts<?php echo $module;?>">
    <div   class="mega-filters  button-group   btn-group">  
       <button class="mega-btn active btn-filter" data-filter="*">show all</button>
        ...
        ?>
        <button class="mega-btn btn-filter" data-filter=".megacatid-<?php echo $category['category_id']; ?>"><?php echo $category['category_name'];?></button>  
        <?php } ?>
    </div>
    <div class="isotope row clearfix">
       ...
       <?php if($max_page>1) { ?>
       <div class="mega-loadmore btn btn-outline-black" data-currentpage="1" data-limitpage="<?php echo $max_page;?>"><?php echo $text_load_more;?> (<span class="page-counter" >1/<?php echo $max_page;?></span>)</div>
       <?php } ?>
