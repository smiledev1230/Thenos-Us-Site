...
$productLayout = DIR_TEMPLATE.$objconfig->get('config_template').'/template/common/product/'.$listingConfig['product_layout'].'.tpl';
?>
<div class="box box-highlights pav-categorytab clearfix">		
	<div class="box-wapper ">		
		<div class="box-heading <?php echo $prefix_class ?>">
		...
		<div class="tab-nav">
			...
			<ul class="nav nav-pills" id="pav-categorytabs<?php echo $id;?>">
		...
		<div class="tab-content">
			<?php $i=0; foreach ($tabs as $key=>$tab) { $i++;?>
				<?php
					...
					$active = ($i==1)?"active":'';
				?>
				<div class="tab-pane <?php echo $active;?> clearfix" id="tab<?php echo $id."-cat".$key;?>">
					<?php if( count($products) > $itemsperpage ) { ?>
					<div class="carousel-controls">
						<a class="carousel-control left fa fa-angle-left" href="#list<?php echo $id."-cat".$key;?>" data-slide="prev"></a>
						<a class="carousel-control right fa fa-angle-right" href="#list<?php echo $id."-cat".$key;?>" data-slide="next"></a>
					...
					<div class="carousel-inner carousel<?php echo $id;?> slide" id="list<?php echo $id."-cat".$key;?>">
						...
						<div class="item <?php if($k==0) {?>active<?php } ?>">
							<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
								...
								<?php } ?>
									<div class="col-md-<?php echo $span;?> col-sm-6 col-xs-12 product-col">
...
<div class="box box-normal border products-bestseller <?php echo $prefix_p; ?>">
	...
	<div class="box-content">	
		<div class="products-block">
			...
			<div class="carousel-controls">
				<a class="carousel-control left fa fa-angle-left" href="#cols<?php echo $id."-cat".$key;?>" data-slide="prev"></a>
				<a class="carousel-control left fa fa-angle-right" href="#cols<?php echo $id."-cat".$key;?>" data-slide="next"></a>
			</div><!-- end div.carousel-controls-->
			<?php } ?>
