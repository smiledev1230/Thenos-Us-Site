                                ...
                                <form method="post" action="scripts/contact.php" name="contactform" id="contactform">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control " name="subject" type="text" id="subject" placeholder="<?php if($subject!='') echo $subject; else echo 'Subject'; ?>">
                                            </div>
                                            <div class="col-md-12">
                                            	
                                                <textarea class="form-control " id="msg" rows="3" placeholder="Message"></textarea><div style="float:left;margin:0;padding:0">
                                                <button class="btn btn-primary btn-med" type="submit" id="submit" name="submit" data-loading-text="Loading..."><i class="fa fa-send"></i> Send Message</button>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
